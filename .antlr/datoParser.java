...
public class datoParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public TerminalNode ClickTime() { return getToken(datoParser.ClickTime, 0); }
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			{
			setState(2);
			((StartContext)_localctx).d = match(ClickTime);
			setState(3);
			match(EOF);
			}
		}
	...
	public static final String _serializedATN =
		"\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\21\b\4\2\t\2\3\2"+
		"\3\2\3\2\3\2\2\2\3\2\2\2\2\6\2\4\3\2\2\2\4\5\7\17\2\2\5\6\7\2\2\3\6\3"+
		"\3\2\2\2\2";
